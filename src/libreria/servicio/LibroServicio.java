...
public class LibroServicio {
    ...
    public List<Libro> disponibilidadDeUnLibro(String titulo) throws Exception {
        try {

            // busca los libros por titulos
            List libro = dao.buscaPorTitulo(titulo);
    ...
    public void formatearTabla(List<Libro> libros) throws SQLException {
        // Print the list objects in tabular format.
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%1s %40s %15s %15s %15s", "ID", "Titulo", " Año", "Ejemplares", "Ejemplares Prestados");
        System.out.println();
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
        
        libros.stream().map((libro) -> {
            System.out.format("%5s %40s %15s %15s %15s",
                    libro.getId(), libro.getTitulo(), libro.getAnio(), libro.getEjemplares(), libro.getEjemplaresPrestados());
            return libro;
        }).forEachOrdered((_item) -> {
            System.out.println();
        });
